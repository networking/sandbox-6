...
t.add("link_edit", "Endre", "SonataAdminBundle", "no");
...
t.add("title_show", "Vis \"%name%\"", "SonataAdminBundle", "no");
...
t.add("flash_lock_error", "En annen bruker har endret elementet \"%name%\". Vennligst %link_start%klikk her%link_end% for \u00e5 laste inn siden p\u00e5 nytt og bruke endringene igjen.", "SonataAdminBundle", "no");
t.add("flash_batch_delete_success", "Valgte objekt har blitt slettet", "SonataAdminBundle", "no");
t.add("flash_batch_no_elements_processed", "Ingen elementer behandlet.", "SonataAdminBundle", "no");
...
t.add("form_not_available", "Skjema er ikke tilgjengelig\n        ", "SonataAdminBundle", "no");
...
t.add("export_format_xlsx", "XLSX", "SonataAdminBundle", "no");
...
t.add("list.label__actions", "Handlinger", "SonataAdminBundle", "no");
...
t.add("stats_view_more", "Se mer", "SonataAdminBundle", "no");
t.add("preview_view_more", "Se mer", "SonataAdminBundle", "no");
...
t.add("label_unknown_user", "ukjent", "SonataAdminBundle", "no");
t.add("read_more", "Les mer", "SonataAdminBundle", "no");
t.add("read_less", "Lukke", "SonataAdminBundle", "no");
t.add("toggle_navigation", "Bytt navigering", "SonataAdminBundle", "no");
t.add("label_type_starts_with", "begynner med", "SonataAdminBundle", "no");
t.add("label_type_ends_with", "slutter med", "SonataAdminBundle", "no");
t.add("go_to_the_first_page", "G\u00e5 til f\u00f8rste side", "SonataAdminBundle", "no");
